...
async function deletarServicos() {
  console.log('=== Deletando Serviços Que Não São Montagem de Móveis ===\n');
  
  const servicos = JSON.parse(fs.readFileSync('servicos_nao_montagem.json', 'utf-8'));
...
deletarServicos().catch(console.error);